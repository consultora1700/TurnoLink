...
import { ShoppingBag, DollarSign, XCircle, PackageCheck } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import type { OrderReportOverview } from '@/lib/api';

const formatCurrency = (amount: number) =>
  new Intl.NumberFormat('es-AR', { style: 'currency', currency: 'ARS', maximumFractionDigits: 0 }).format(amount);

export function OrderOverviewKpis({ data }: { data: OrderReportOverview }) {
  const kpis = [
    {
    ...
    },
    {
      ...
      subtitle: `${data.deliveredOrders + data.confirmedOrders} ventas efectivas`,
      icon: DollarSign,
    ...
    },
    {
      ...
      subtitle: `${data.deliveredOrders} pedidos entregados`,
      icon: PackageCheck,
    ...
    },
    {
      ...
      subtitle: `${data.cancelledOrders} pedidos cancelados`,
      icon: XCircle,
