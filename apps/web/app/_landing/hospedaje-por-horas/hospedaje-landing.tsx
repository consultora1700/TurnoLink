...
const SUB_INDUSTRIES = [
  { emoji: '🏩', name: 'Albergues transitorios', desc: 'Alta rotación por turnos cortos, operación 24/7', slug: 'albergues-transitorios' },
  { emoji: '🏨', name: 'Hoteles por turno', desc: 'Habitaciones por bloque horario con check-in express', slug: 'hoteles-por-turno' },
  { emoji: '🛏️', name: 'Hostels por bloque', desc: 'Camas y habitaciones compartidas por horas', slug: 'hostels-por-bloque' },
  { emoji: '🕐', name: 'Habitaciones 12 hs', desc: 'Bloques de medio día para estadías cortas', slug: 'habitaciones-12hs' },
  { emoji: '🚪', name: 'Boxes privados', desc: 'Espacios privados por hora con rotación rápida', slug: 'boxes-privados' },
];
...
// FAQs moved to ./hospedaje-faqs.ts for server component compatibility
import { HOSPEDAJE_FAQS } from './hospedaje-faqs';
export { HOSPEDAJE_FAQS };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
              <Link
                href="/register?industry=hospedaje-por-horas"
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div ref={cardsRef} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4">
          {SUB_INDUSTRIES.map((item, i) => (
            <Link
              key={i}
              href={`/hospedaje-por-horas/${item.slug}`}
...
export function HospedajeLanding({ dynamicPricing }: { dynamicPricing?: PricingTier[] } = {}) {
