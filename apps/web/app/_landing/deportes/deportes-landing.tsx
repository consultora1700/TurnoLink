...
const SUB_INDUSTRIES = [
  { emoji: '⚽', name: 'Canchas de fútbol', desc: 'Fútbol 5, 7, 8 y 11 — gestión de múltiples canchas', slug: 'canchas-de-futbol' },
  { emoji: '🏸', name: 'Canchas de pádel', desc: 'Reservas por hora, torneos y clases', slug: 'canchas-de-padel' },
  { emoji: '🎾', name: 'Tenis', desc: 'Singles, dobles y clases con coach', slug: 'tenis' },
  { emoji: '🏀', name: 'Básquet', desc: 'Canchas por hora y ligas recreativas', slug: 'basquet' },
  { emoji: '💃', name: 'Estudios de danza', desc: 'Clases, ensayos y eventos por hora', slug: 'estudios-de-danza' },
  { emoji: '🏋️', name: 'Gimnasios por clase', desc: 'CrossFit, funcional, spinning y más', slug: 'gimnasios-por-clase' },
  { emoji: '🏃', name: 'Entrenadores personales', desc: 'Sesiones individuales y grupos reducidos', slug: 'entrenadores-personales' },
  { emoji: '🎵', name: 'Salas de ensayo', desc: 'Bandas, músicos y producción musical', slug: 'salas-de-ensayo' },
  { emoji: '🎙️', name: 'Estudios de grabación', desc: 'Grabación, mezcla y producción por hora', slug: 'estudios-de-grabacion' },
];
...
// FAQs moved to ./deportes-faqs.ts for server component compatibility
import { DEPORTES_FAQS } from './deportes-faqs';
export { DEPORTES_FAQS };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
              <Link
                href="/register?industry=deportes"
        ...
        <div className="lv2-card p-8 sm:p-12">
          ...
          <div className="text-center border-t border-white/[0.06] pt-8">
            ...
            <p className="text-white/40 text-sm mt-4">
              Plan Profesional: $14.999/mes &mdash;{' '}
...
export function DeportesLanding({ dynamicPricing }: { dynamicPricing?: PricingTier[] } = {}) {
