...
const SUB_INDUSTRIES = [
  { emoji: '🏢', name: 'Coworking', desc: 'Escritorios compartidos, hot desks y puestos fijos por hora o día', slug: 'coworking' },
  { emoji: '🏬', name: 'Oficinas por hora', desc: 'Oficinas privadas para reuniones, entrevistas y trabajo concentrado', slug: 'oficinas-por-hora' },
  { emoji: '🤝', name: 'Salas de reuniones', desc: 'Salas equipadas para meetings, capacitaciones y workshops', slug: 'salas-de-reuniones' },
  { emoji: '💼', name: 'Boxes profesionales', desc: 'Consultorios y espacios privados por turno para profesionales', slug: 'boxes-profesionales' },
  { emoji: '🎨', name: 'Estudios compartidos', desc: 'Estudios de diseño, fotografía, podcast y producción', slug: 'estudios-compartidos' },
];
...
// FAQs moved to ./espacios-faqs.ts for server component compatibility
import { ESPACIOS_FAQS } from './espacios-faqs';
export { ESPACIOS_FAQS };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
              <Link
                href="/register?industry=espacios-flexibles"
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div ref={cardsRef} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {SUB_INDUSTRIES.map((item, i) => (
            <Link
              key={i}
              href={`/espacios-flexibles/${item.slug}`}
...
export function EspaciosLanding({ dynamicPricing }: { dynamicPricing?: PricingTier[] } = {}) {
