...
import { getSubNicheSlugs, getSubNicheData } from '../../_landing/_data/niche-registry';
import { IndustryPage } from '../../_landing/_components/industry-page';
import { fetchPricingByGroup } from '../../_landing/_components/pricing-api';
import { BreadcrumbListJsonLd, FaqJsonLd } from '../../_landing/_components/seo-schemas';

const NICHE = 'mercado';
const NICHE_LABEL = 'Mercado';
